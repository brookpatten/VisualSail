    ...
    public class PrimitiveLine
    {
        ...
        public void Render(SpriteBatch spriteBatch)
        {
            ...
            for (int i = 1; i < vectors.Count; i++)
            {
                ...
                spriteBatch.Draw(pixel, Position + vector1, null, Colour, angle, Vector2.Zero, new Vector2(distance, Thickness), SpriteEffects.None, Depth);
            }
        }
        ...
        public void CreateEllipse(float semimajor_axis, float semiminor_axis, float angle_offset, int sides)
        {
            ...
            {
                vectors[i] = Vector2.Transform(vectors[i], m);
            }
        }
    }
}
