...
namespace AmphibianSoftware.Video
{
    ...
    public class AviWriter {
      ...
      public Bitmap Open(string fileName, UInt32 frameRate, int width, int height) {
        ...
        {
            BitmapData bmpDat = bmp_.LockBits(new Rectangle(0,0,(int) width_, (int) height_),ImageLockMode.ReadOnly,PixelFormat.Format24bppRgb);
        ...
        public void AddFrame(IntPtr p,int len)
        {
            int hr = AVIStreamWrite(psCompressed_, count_, 1,
            p, // pointer to data
            len,
